...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="qr-code">
                <img src="https://via.placeholder.com/150x150.png?text=Train+Image" alt="User Avatar">
                <h1>John Doe</h1>

                <ul>
                <li>
                    <span>Subscription Type:</span> Monthly Pass
                </li>
                <li>
                    <span>Start Date:</span> May 1, 2023
                </li>
                <li>
                    <span>End Date:</span> May 31, 2023
                </li>
                <p>Enter text to generate QR code:</p>
            <input type="text" id="qrText" default="0">
