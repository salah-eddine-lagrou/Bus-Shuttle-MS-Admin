...
<link rel="apple-touch-icon" sizes="76x76" href="/img/apple-icon.png">
    ...
    <style>
        ...
        box-shadow: 0 0 5px #888; /* Ombre portée */
        padding: 10px; /* Marge intérieure pour l'espace entre l'image et la bordure */
...
@php
                        ...
                        <div class="card-body p-3">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div  class ="border rounded p-3"id="map"
                                        >
                                            </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div>
                                                            {{-- <video src="/autocars/dicore.mp4" autoplay loop muted
                                                                playsinline
                                                                style="max-width: 60%; height: auto;"></video> --}}
    ...
    <script>
    var map = L.map('map').setView([{{ $destinationCitieDepart->destinationCitieDepartlat }}, {{ $destinationCitieDepartlng->destinationCitieDepartlng }}], 3);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors'
    }).addTo(map);
    L.Routing.control({
        waypoints: [
            L.latLng({{ $destinationCitieDepart->destinationCitieDepartlat }}, {{ $destinationCitieDepartlng->destinationCitieDepartlng }}),
            L.latLng({{ $destinationCitieDestination->destinationCitieDestinationlat }}, {{ $destinationCitieDestinationlng->destinationCitieDestinationlng }}),
        ],
