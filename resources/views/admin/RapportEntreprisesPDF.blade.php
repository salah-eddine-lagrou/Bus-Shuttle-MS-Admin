...
<table>
    ...
    <tbody>
      ...
      <tr>
        <td><small>{{$entreprise->id}}</small></td>
        <td><small>{{$entreprise->nom}}</small></td>
        <td><small>{{$entreprise->email}}</small></td>
        <td><small>{{$entreprise->adresse}}</small></td>
        <td><small>{{$entreprise->telephone}}</small></td>
        <td><small>{{$entreprise->siteWeb}}</small></td>
        <td><small>{{$entreprise->created_at}}</small></td>
      </tr>
      @endforeach
    </tbody>
  </table>
