...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
	...
	<div class="container">
		<h2 class="text-center my-5">Clients Profiles</h2>
        <div class="row">
            
            <form class="d-flex ms-auto" method="get" action="{{route('ClientsProfiles')}}" >
                @csrf
                <div class="col-md-4 offset-md-8">
                    <div class="input-group mb-3">
                        <input type="search" name="search" id="search" class="form-control rounded-pill border-start-8" placeholder="Search...">
                    </div>
                    <div class="input-group mb-3">
                        <button  class="btn btn-primary rounded-pill order-md-1"  type="submit"><i class="fas fa-search"></i></button>
                    </div>
                </div>
            </form>
        </div>
  ...
  <div class="profile-details">
    <div class="profile-info">
      <h4 class="info-heading">About</h4>
      <p class="info-content">John Doe is a skilled software engineer with experience in developing web applications using various technologies. He has a strong understanding of object-oriented programming and is proficient in Java, Python, and JavaScript.</p>
    </div>
    
    <div class="profile-info">
      <h4 class="info-heading">Education
