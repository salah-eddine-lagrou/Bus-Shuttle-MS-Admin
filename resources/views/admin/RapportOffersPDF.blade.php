...
<table>
    ...
    <tbody>
      ...
      <tr>
        <td><small>{{$offre->id}}</small></td>
        <td><small>{{$offre->titre}}</small></td>
        <td><small>{{$offre->description}}</small></td>
        <td><small>{{$offre->dateFinOffre}}</small></td>
        <td><small>{{$offre->created_at}}</small></td>
      </tr>
      @endforeach
    </tbody>
  </table>
