...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Clients Table</h6>
            </nav>
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                    <div class="input-group">
                        <form class="d-flex ms-auto" method="get" action="{{route('ListesClients')}}">
...
<!--PART 1-->
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="date font-weight-bolder mb-0">
                                    {{ now() }}
                                    </h5>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    {{ $NombreAbonnement[0]->NombreAbonnements }}
                                   </h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
    ...
    <div class="row mt-4">
            ...
            <div class="col-lg-16 mb-lg-0 mb-4 ">
            ...
            <div class="col-12">
                <div class="card mb-4">
                  ...
                  <h6 class="mb-0">Client List</h6> <table class="table align-items-center mb-0">
                    ...
                    <div class="col-6 d-flex align-items-center">
                                ...
                                <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">#</th>
                                    <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">FullName</th>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7"> Last Update</th>
                                ...
                                <tr>
                                <div class="row">
  <div id="offcanvas" class="offcanvas offcanvas-end offcanvas-col-8 bg-white">
    <div class="offcanvas-header">
      <h5 class="offcanvas-title">Update Client Profil:</h5>
    </div>
    <div class="offcanvas-body mt-2">
      ...
      <form role="form" id="contact-form" method="post" action="{{route('updateClient',  ['id' => $client->id])}}" autocomplete="off">
      @csrf  
      <div class="card-body">
          <div class="row">
            <div class="col-md-6">
            <input type="hidden" id="id" name="id" value="{{$client->id}}">
              ...
              <div class="input-group mb-4">
                <input id="nom" name="nom" class="form-control" value="{{$client->nom}}" aria-label="First Name..." type="text">
              </div>
            </div>
            <div class="col-md-6 ps-2">
              <label>Last Name</label>
              <div class="input-group">
                <input id="prenom" name="prenom" type="text" class="form-control" placeholder="last name" aria-label="Last Name...">
              </div>
            </div>
            <div class="col-md-6">
              <label>Address</label>
              <div class="input-group mb-4">
                <input id="adresse" name="adresse" class="form-control" value="{{$client->adresse}}" aria-label="First Name..." type="text">
              </div>
            </div>
            <div class="col-md-6 ps-2">
              <label>Phone</label>
              <div class="input-group">
                <input id="telephone" name="telephone" type="number"  value="{{$client->telephone}}" class="form-control" placeholder="" aria-label="Last Name...">
              </div>
            </div>
          </div>
          <div class="mb-4">
            ...
            <div class="input-group">
              <input id="email" name="email" type="email"  value="{{$client->email}}" class="form-control" placeholder="">
            </div>
          </div>
          <div class="col-md-12">
            <button type="submit" class="btn bg-gradient-dark w-100">Validate</button>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <span class="badge badge-sm bg-gradient-success">{{$client->id}}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td class="align-middle text-center">
                                        <span class="text-secondary text-xs font-weight-bold">{{$client->adresse}}</span>
                                    </td>
                                    <td class="align-middle text-center">
                                        <span class="text-secondary text-xs font-weight-bold">{{$client->telephone}}</span>
                                    </td>
                                    <td class="align-middle">
                                    <a href="" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas" class="btn btn-success text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                             Update
                                        </a> <a href="{{route('deleteClient',['id' => $client->id])}}" class="btn btn-danger text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                             Delete
                                        </a>
                                    </td>
                                    <td class="align-middle text-center">
                                        <span class="text-secondary text-xs font-weight-bold">{{$client->created_at}}</span>
                                    </td>
                                    <td class="align-middle text-center">
                                        <span class="text-secondary text-xs font-weight-bold">{{$client->updated_at}}</span>
                                    </td>
                                </tr>
                                @endforeach
...
<script type="text/javascript">
    var userData = <?php echo json_encode($ClientData)?>;
    Highcharts.chart('container', {
        title: {
            text: 'New Client of the Year '
        },
        subtitle: {
            text: ''
        },
