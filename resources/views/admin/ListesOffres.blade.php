...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
            ...
            <span class="ms-1 font-weight-bold">Subscribes Management System</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  active" href="../pages/tables.html">
                    ...
                    <span class="nav-link-text ms-1">Societies</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="../pages/billing.html">
                    ...
                    <span class="nav-link-text ms-1">Subscribes</span>
                </a>
            </li>
            <li class="nav-item">
    ...
    <div class="sidenav-footer mx-3 ">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-start p-3 w-100">
                ...
                <div class="docs-info">
                    <h6 class="text-white up mb-0">mr foulane </h6>
                    <p class="text-xs font-weight-bold">Welcome</p>
                    <a href="https://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-dashboard" target="_blank" class="btn btn-white btn-sm w-100 mb-0">View Profile</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-7 mt-4">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">Offers Information</h6>
            </div>
 ...
 @foreach($offres as $offre)        
              <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    <h6 class="mb-3 text-sm"><BR>{{$offre->titre}}</h6>
                    <span class="text-xs"> Description: <span class="text-dark ms-sm-2 font-weight-bold">{{$offre->description}}</span></span>
                    <span class="mb-2 text-xs"><br>Company Name: <span class="text-dark font-weight-bold ms-sm-2">$offre->entreprise->name</span></span>
                    <span class="mb-2 text-xs">Email Address: <span class="text-dark ms-sm-2 font-weight-bold">$offre->entreprise->id</span></span>
                   </div>
        ...
        <div class="col-md-5 mt-4">
          <div class="card h-100 mb-4">
            <div class="card-header pb-0 px-3">
              <div class="row">
                <div class="col-md-6">
                  <h6 class="mb-0">List of subscriptions</h6>
                </div>
            ...
            <ul class="list-group">
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    <button href="#" class="btn btn-icon-only btn-rounded btn-outline-danger mb-0 me-3 btn-sm d-flex align-items-center justify-content-center"><i class="fas fa-arrow-down" aria-hidden="true"></i></button>
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm">Name : </h6>
                      <span class="text-xs">Type :</span>
                      <span class="text-xs">Trajet :</span>
                    </div>
                  </div>
