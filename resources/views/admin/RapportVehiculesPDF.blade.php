...
<table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><small>{{$vehicle->immatriculation}}</small></td>
        <td><small>{{$vehicle->marque}}</small></td>
        <td><small>{{$vehicle->capacite}}</small></td>
        <td><small>{{$vehicle->dateMiseEnservice}}</small></td>
        <td><small>{{$vehicle->created_at}}</small></td>
      </tr>
      @endforeach
    </tbody>
  </table>
